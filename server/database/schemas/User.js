...
const userSchema = new Schema(
  {
    ...
    planting_ground: { type: String, required: true },
    full_name_responsible_personal: { type: String, required: true },
    phone_number_responsible_person: { type: String, required: true },
    full_name_responsible_organization: { type: String, required: true },
    phone_number_responsible_organization: { type: String, required: true },
